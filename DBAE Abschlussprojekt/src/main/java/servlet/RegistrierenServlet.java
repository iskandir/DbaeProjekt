...
/**
 * Servlet wird genutzt um dem Nutzer die Möglichkeit zu geben sich zu
 * registrieren
 * 
...
public class RegistrierenServlet extends HttpServlet {
	...
	/**
	 * Fragt die benötigten Parameter aus dem registrierung.jsp ab und speichert
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!(benutzer.getPassword().isEmpty()))
			...
			if (password.equals(passwordWdh)) {
				// Prüfe ob StatementsDB.benutzerHinzufuegen true, dann setze Attribute und gehe
				// auf die index.jsp
